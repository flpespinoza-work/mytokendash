<div class="flex flex-col">
    <div class="items-center md:flex">
        <div class="w-1/5 px-2 space-y-2">
            ...
            <select wire:model.lazy="store" id="store" name="store" autocomplete="store" class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                <option></option>
        ...
        <div class="w-1/5 px-2 space-y-2">
            <button type="button" wire:click="generateReport">Generar reporte</button>
        </div>
    </div>


    @if ($areaChartModel)
    <div class="w-full p-3 mt-5 bg-white border border-gray-100 rounded-md shadow-sm lg:mt-8 h-96">
