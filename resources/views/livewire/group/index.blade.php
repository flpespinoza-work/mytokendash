<div>
    <div class="flex flex-col w-full pb-10">
        <div class="flex items-center">
            ...
            <a x-data="{}" x-on:click="window.livewire.emitTo('group-modal', 'show')" class="flex items-center flex-shrink-0 p-2 ml-auto text-xs font-bold leading-tight tracking-wide bg-blue-700 rounded-md shadow md:p-3 text-blue-50" >
                <x-heroicon-s-plus-circle class="w-4 h-4 md:w-5 md:h-5 md:mr-2"/>
                <span class="hidden cursor-pointer md:inline-block">
                    Nuevo grupo
                </span>
            </a>
        </div>
