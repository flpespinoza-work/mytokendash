<div>
    <div class="flex flex-col w-full pb-10">
        <div class="flex items-center">
            ...
            <a class="px-2 py-3 ml-auto text-xs font-bold bg-blue-600 rounded-md shadow text-blue-50" href="{{ route('users.create') }}">Nuevo usuario</a>
        </div>
                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @foreach($user->roles as $key => $role)
                                <span class="inline-flex px-2 text-xs font-semibold leading-5 text-blue-800 bg-blue-100 rounded-full">{{ $role->name }}</span>
                            @endforeach
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
