...
<div class="absolute top-20 w-80 right-20 px-4 py-4 rounded-md bg-white border shadow-md sm:p-6 sm:pb-4 {{ $type }}">
        <div class="sm:flex sm:items-start">
            <div class="flex items-center justify-center flex-shrink-0 w-5 h-5 mx-auto bg-red-100 rounded-full sm:mx-0 sm:h-7 sm:w-7">
